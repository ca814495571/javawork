...
public class DateUtils {
	...
	/**
	 * num 正数则是向后偏移的日期  负数则是向前偏移的日期
	 * 
	 * @param date
	 * @return
	 */
	public static String getPreDay(Date date,int num) {
		String preDate = "";
	...
	public static String toHtmlTime(String time ,int format){
	...
	public static void main(String[] args){
			System.out.println(toHtmlTime("2015-05-12 00:00:00.00",2));
	}
