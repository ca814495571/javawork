...
public class StationInfoDao {
	...
	public List<StationInfo> getStationInfoByWhereAnd(StationInfo stationInfo) {
		...
		if (!"".equals(stationInfo.getActive()) && stationInfo.getActive() != 0) {
			where.append(" and active = '");
			where.append(stationInfo.getActive());
			where.append("'");
		} else {

			where.append(" and active = '1'");
	...
	public List<StationInfo> checkStationName (String name ,String updateName){
		...
		return stationInfoMapper.checkStationName(name, updateName);
	}
	
	public List<StationInfo> checkStationCode (String code ,String updateCode){
		
		
		return stationInfoMapper.checkStationCode(code, updateCode);
	}
	...
	public int updateByParentId(int parentId ,String name){
		...
		return stationInfoMapper.updateByParentId(parentId, name);
	 ...
	 * @return
	 */
	public List<StationInfo> getStationInfoByWhere(StationInfo stationInfo,
			String addressOne, String keyword, int pageNum, int pageSize,
			int flag) {

		StringBuffer sb = new StringBuffer(" 1=1 ");

		if (!"".equals(stationInfo.getId()) && flag == 0) {
		...
		sb.append(" and active = 1 order by lastTime desc");
	...
	public int getRecordTotalByWhere(StationInfo stationInfo,
			String addressOne, String keyword, int flag) {
