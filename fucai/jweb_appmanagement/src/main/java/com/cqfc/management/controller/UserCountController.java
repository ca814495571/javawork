...
public class UserCountController {
	...
	@ResponseBody
	public void insertUserCount() throws ParseException {
		...
		Date date = DateUtils.stringToDateTwo("2014-6-5");
		...
		for (int i = 0; i < fenzhongxin.size(); i++) {
			...
			for (int j = 0; j < stations.size(); j++) {
				...
				insertUser(station2, uc, 40, date);
	...
	public void insertUser(StationInfo station, UserCount userCount,
		...
		userCount.setCountTime(DateUtils.formatDateTwo(date));
