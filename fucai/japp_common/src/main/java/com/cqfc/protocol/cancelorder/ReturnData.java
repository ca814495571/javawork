...
public class ReturnData implements org.apache.thrift.TBase<ReturnData, ReturnData._Fields>, java.io.Serializable, Cloneable, Comparable<ReturnData> {
  ...
  public List<CancelOrder> resultList; // required
  ...
  public ReturnData(ReturnData other) {
    ...
    if (other.isSetResultList()) {
      List<CancelOrder> __this__resultList = new ArrayList<CancelOrder>(other.resultList.size());
      for (CancelOrder other_element : other.resultList) {
        __this__resultList.add(new CancelOrder(other_element));
      }
  ...
  public java.util.Iterator<CancelOrder> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(CancelOrder elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<CancelOrder>();
    }
    this.resultList.add(elem);
  }

  public List<CancelOrder> getResultList() {
    return this.resultList;
  }

  public ReturnData setResultList(List<CancelOrder> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<CancelOrder>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<CancelOrder>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  CancelOrder _elem2;
                  _elem2 = new CancelOrder();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReturnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (CancelOrder _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (CancelOrder _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<CancelOrder>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            CancelOrder _elem7;
            _elem7 = new CancelOrder();
            _elem7.read(iprot);
