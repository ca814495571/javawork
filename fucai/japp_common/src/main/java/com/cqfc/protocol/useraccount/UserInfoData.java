...
public class UserInfoData implements org.apache.thrift.TBase<UserInfoData, UserInfoData._Fields>, java.io.Serializable, Cloneable, Comparable<UserInfoData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserInfoData");
  ...
  static {
    schemes.put(StandardScheme.class, new UserInfoDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserInfoDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<UserInfo> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserInfoData.class, metaDataMap);
  }
   ...
   */
  public UserInfoData(UserInfoData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<UserInfo> __this__resultList = new ArrayList<UserInfo>(other.resultList.size());
      for (UserInfo other_element : other.resultList) {
        __this__resultList.add(new UserInfo(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public UserInfoData deepCopy() {
  ...
  public UserInfoData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public UserInfoData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public UserInfoData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<UserInfo> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(UserInfo elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<UserInfo>();
    }
  ...
  public UserInfoData setResultList(List<UserInfo> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<UserInfo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserInfoData)
      return this.equals((UserInfoData)that);
    return false;
  }

  public boolean equals(UserInfoData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UserInfoData other) {
  ...
  private static class UserInfoDataStandardSchemeFactory implements SchemeFactory {
    public UserInfoDataStandardScheme getScheme() {
      return new UserInfoDataStandardScheme();
    }
  }

  private static class UserInfoDataStandardScheme extends StandardScheme<UserInfoData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserInfoData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<UserInfo>(_list16.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserInfoData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (UserInfo _iter19 : struct.resultList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class UserInfoDataTupleSchemeFactory implements SchemeFactory {
    public UserInfoDataTupleScheme getScheme() {
      return new UserInfoDataTupleScheme();
    }
  }

  private static class UserInfoDataTupleScheme extends TupleScheme<UserInfoData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserInfoData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (UserInfo _iter20 : struct.resultList)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserInfoData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<UserInfo>(_list21.size);
