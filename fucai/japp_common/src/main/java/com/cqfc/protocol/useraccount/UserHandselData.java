...
public class UserHandselData implements org.apache.thrift.TBase<UserHandselData, UserHandselData._Fields>, java.io.Serializable, Cloneable, Comparable<UserHandselData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserHandselData");
  ...
  static {
    schemes.put(StandardScheme.class, new UserHandselDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserHandselDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<UserHandsel> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserHandselData.class, metaDataMap);
  }

  public UserHandselData() {
  }
   ...
   */
  public UserHandselData(UserHandselData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<UserHandsel> __this__resultList = new ArrayList<UserHandsel>(other.resultList.size());
      for (UserHandsel other_element : other.resultList) {
        __this__resultList.add(new UserHandsel(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public UserHandselData deepCopy() {
    return new UserHandselData(this);
  }
  ...
  public UserHandselData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public UserHandselData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public UserHandselData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<UserHandsel> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(UserHandsel elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<UserHandsel>();
    }
    this.resultList.add(elem);
  }

  public List<UserHandsel> getResultList() {
    return this.resultList;
  }

  public UserHandselData setResultList(List<UserHandsel> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<UserHandsel>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserHandselData)
      return this.equals((UserHandselData)that);
    return false;
  }

  public boolean equals(UserHandselData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UserHandselData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserHandselData(");
    boolean first = true;
  ...
  private static class UserHandselDataStandardSchemeFactory implements SchemeFactory {
    public UserHandselDataStandardScheme getScheme() {
      return new UserHandselDataStandardScheme();
    }
  }

  private static class UserHandselDataStandardScheme extends StandardScheme<UserHandselData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserHandselData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<UserHandsel>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  UserHandsel _elem26;
                  _elem26 = new UserHandsel();
                  _elem26.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserHandselData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (UserHandsel _iter27 : struct.resultList)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class UserHandselDataTupleSchemeFactory implements SchemeFactory {
    public UserHandselDataTupleScheme getScheme() {
      return new UserHandselDataTupleScheme();
    }
  }

  private static class UserHandselDataTupleScheme extends TupleScheme<UserHandselData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserHandselData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (UserHandsel _iter28 : struct.resultList)
          {
            _iter28.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserHandselData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<UserHandsel>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            UserHandsel _elem31;
            _elem31 = new UserHandsel();
            _elem31.read(iprot);
