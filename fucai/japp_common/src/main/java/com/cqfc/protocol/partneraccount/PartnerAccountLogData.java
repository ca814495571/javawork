...
public class PartnerAccountLogData implements org.apache.thrift.TBase<PartnerAccountLogData, PartnerAccountLogData._Fields>, java.io.Serializable, Cloneable, Comparable<PartnerAccountLogData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PartnerAccountLogData");
  ...
  static {
    schemes.put(StandardScheme.class, new PartnerAccountLogDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PartnerAccountLogDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<PartnerAccountLog> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PartnerAccountLogData.class, metaDataMap);
  }

  public PartnerAccountLogData() {
  }
  ...
  public PartnerAccountLogData(
    ...
    int pageSize,
    int totalSize,
    List<PartnerAccountLog> resultList)
  {
    this();
   ...
   */
  public PartnerAccountLogData(PartnerAccountLogData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<PartnerAccountLog> __this__resultList = new ArrayList<PartnerAccountLog>(other.resultList.size());
      for (PartnerAccountLog other_element : other.resultList) {
        __this__resultList.add(new PartnerAccountLog(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public PartnerAccountLogData deepCopy() {
    return new PartnerAccountLogData(this);
  }
  ...
  public PartnerAccountLogData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public PartnerAccountLogData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public PartnerAccountLogData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<PartnerAccountLog> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(PartnerAccountLog elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<PartnerAccountLog>();
    }
    this.resultList.add(elem);
  }

  public List<PartnerAccountLog> getResultList() {
    return this.resultList;
  }

  public PartnerAccountLogData setResultList(List<PartnerAccountLog> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<PartnerAccountLog>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartnerAccountLogData)
      return this.equals((PartnerAccountLogData)that);
    return false;
  }

  public boolean equals(PartnerAccountLogData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PartnerAccountLogData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartnerAccountLogData(");
    boolean first = true;
  ...
  private static class PartnerAccountLogDataStandardSchemeFactory implements SchemeFactory {
    public PartnerAccountLogDataStandardScheme getScheme() {
      return new PartnerAccountLogDataStandardScheme();
    }
  }

  private static class PartnerAccountLogDataStandardScheme extends StandardScheme<PartnerAccountLogData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PartnerAccountLogData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<PartnerAccountLog>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  PartnerAccountLog _elem10;
                  _elem10 = new PartnerAccountLog();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartnerAccountLogData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (PartnerAccountLog _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PartnerAccountLogDataTupleSchemeFactory implements SchemeFactory {
    public PartnerAccountLogDataTupleScheme getScheme() {
      return new PartnerAccountLogDataTupleScheme();
    }
  }

  private static class PartnerAccountLogDataTupleScheme extends TupleScheme<PartnerAccountLogData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PartnerAccountLogData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (PartnerAccountLog _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PartnerAccountLogData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<PartnerAccountLog>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            PartnerAccountLog _elem15;
            _elem15 = new PartnerAccountLog();
            _elem15.read(iprot);
