...
public class PartnerAccountData implements org.apache.thrift.TBase<PartnerAccountData, PartnerAccountData._Fields>, java.io.Serializable, Cloneable, Comparable<PartnerAccountData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PartnerAccountData");
  ...
  static {
    schemes.put(StandardScheme.class, new PartnerAccountDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PartnerAccountDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<PartnerAccount> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PartnerAccountData.class, metaDataMap);
  }
  ...
  public PartnerAccountData(
    ...
    int pageSize,
    int totalSize,
    List<PartnerAccount> resultList)
  {
    this();
   ...
   */
  public PartnerAccountData(PartnerAccountData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<PartnerAccount> __this__resultList = new ArrayList<PartnerAccount>(other.resultList.size());
      for (PartnerAccount other_element : other.resultList) {
        __this__resultList.add(new PartnerAccount(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public PartnerAccountData deepCopy() {
    return new PartnerAccountData(this);
  }
  ...
  public PartnerAccountData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public PartnerAccountData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public PartnerAccountData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<PartnerAccount> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(PartnerAccount elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<PartnerAccount>();
    }
    this.resultList.add(elem);
  }

  public List<PartnerAccount> getResultList() {
    return this.resultList;
  }

  public PartnerAccountData setResultList(List<PartnerAccount> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<PartnerAccount>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartnerAccountData)
      return this.equals((PartnerAccountData)that);
    return false;
  }

  public boolean equals(PartnerAccountData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PartnerAccountData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartnerAccountData(");
    boolean first = true;
  ...
  private static class PartnerAccountDataStandardSchemeFactory implements SchemeFactory {
    public PartnerAccountDataStandardScheme getScheme() {
      return new PartnerAccountDataStandardScheme();
    }
  }

  private static class PartnerAccountDataStandardScheme extends StandardScheme<PartnerAccountData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PartnerAccountData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<PartnerAccount>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  PartnerAccount _elem2;
                  _elem2 = new PartnerAccount();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartnerAccountData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (PartnerAccount _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PartnerAccountDataTupleSchemeFactory implements SchemeFactory {
    public PartnerAccountDataTupleScheme getScheme() {
      return new PartnerAccountDataTupleScheme();
    }
  }

  private static class PartnerAccountDataTupleScheme extends TupleScheme<PartnerAccountData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PartnerAccountData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (PartnerAccount _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PartnerAccountData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<PartnerAccount>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            PartnerAccount _elem7;
            _elem7 = new PartnerAccount();
            _elem7.read(iprot);
