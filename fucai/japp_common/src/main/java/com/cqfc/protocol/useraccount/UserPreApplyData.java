...
public class UserPreApplyData implements org.apache.thrift.TBase<UserPreApplyData, UserPreApplyData._Fields>, java.io.Serializable, Cloneable, Comparable<UserPreApplyData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserPreApplyData");
  ...
  static {
    schemes.put(StandardScheme.class, new UserPreApplyDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserPreApplyDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<UserPreApply> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserPreApplyData.class, metaDataMap);
  }

  public UserPreApplyData() {
  }
   ...
   */
  public UserPreApplyData(UserPreApplyData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<UserPreApply> __this__resultList = new ArrayList<UserPreApply>(other.resultList.size());
      for (UserPreApply other_element : other.resultList) {
        __this__resultList.add(new UserPreApply(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public UserPreApplyData deepCopy() {
    return new UserPreApplyData(this);
  }
  ...
  public UserPreApplyData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public UserPreApplyData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public UserPreApplyData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<UserPreApply> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(UserPreApply elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<UserPreApply>();
    }
    this.resultList.add(elem);
  }

  public List<UserPreApply> getResultList() {
    return this.resultList;
  }

  public UserPreApplyData setResultList(List<UserPreApply> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<UserPreApply>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserPreApplyData)
      return this.equals((UserPreApplyData)that);
    return false;
  }

  public boolean equals(UserPreApplyData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UserPreApplyData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserPreApplyData(");
    boolean first = true;
  ...
  private static class UserPreApplyDataStandardSchemeFactory implements SchemeFactory {
    public UserPreApplyDataStandardScheme getScheme() {
      return new UserPreApplyDataStandardScheme();
    }
  }

  private static class UserPreApplyDataStandardScheme extends StandardScheme<UserPreApplyData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserPreApplyData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<UserPreApply>(_list48.size);
                for (int _i49 = 0; _i49 < _list48.size; ++_i49)
                {
                  UserPreApply _elem50;
                  _elem50 = new UserPreApply();
                  _elem50.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserPreApplyData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (UserPreApply _iter51 : struct.resultList)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class UserPreApplyDataTupleSchemeFactory implements SchemeFactory {
    public UserPreApplyDataTupleScheme getScheme() {
      return new UserPreApplyDataTupleScheme();
    }
  }

  private static class UserPreApplyDataTupleScheme extends TupleScheme<UserPreApplyData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserPreApplyData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (UserPreApply _iter52 : struct.resultList)
          {
            _iter52.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserPreApplyData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<UserPreApply>(_list53.size);
          for (int _i54 = 0; _i54 < _list53.size; ++_i54)
          {
            UserPreApply _elem55;
            _elem55 = new UserPreApply();
            _elem55.read(iprot);
