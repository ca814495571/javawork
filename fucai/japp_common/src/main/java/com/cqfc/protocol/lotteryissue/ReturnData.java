...
public class ReturnData implements org.apache.thrift.TBase<ReturnData, ReturnData._Fields>, java.io.Serializable, Cloneable, Comparable<ReturnData> {
  ...
  public List<LotteryIssue> resultList; // required
  ...
  public ReturnData(ReturnData other) {
    ...
    if (other.isSetResultList()) {
      List<LotteryIssue> __this__resultList = new ArrayList<LotteryIssue>(other.resultList.size());
      for (LotteryIssue other_element : other.resultList) {
        __this__resultList.add(new LotteryIssue(other_element));
      }
  ...
  public java.util.Iterator<LotteryIssue> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(LotteryIssue elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<LotteryIssue>();
    }
    this.resultList.add(elem);
  }

  public List<LotteryIssue> getResultList() {
    return this.resultList;
  }

  public ReturnData setResultList(List<LotteryIssue> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<LotteryIssue>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<LotteryIssue>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  LotteryIssue _elem10;
                  _elem10 = new LotteryIssue();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReturnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (LotteryIssue _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (LotteryIssue _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<LotteryIssue>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            LotteryIssue _elem15;
            _elem15 = new LotteryIssue();
            _elem15.read(iprot);
