...
public class ReturnData implements org.apache.thrift.TBase<ReturnData, ReturnData._Fields>, java.io.Serializable, Cloneable, Comparable<ReturnData> {
  ...
  public List<WinningOrderInfo> resultList; // required
  ...
  public ReturnData(
    ...
    int pageSize,
    int totalSize,
    List<WinningOrderInfo> resultList)
  {
    this();
  ...
  public ReturnData(ReturnData other) {
    ...
    if (other.isSetResultList()) {
      List<WinningOrderInfo> __this__resultList = new ArrayList<WinningOrderInfo>(other.resultList.size());
      for (WinningOrderInfo other_element : other.resultList) {
        __this__resultList.add(new WinningOrderInfo(other_element));
      }
  ...
  public java.util.Iterator<WinningOrderInfo> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(WinningOrderInfo elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<WinningOrderInfo>();
    }
    this.resultList.add(elem);
  }

  public List<WinningOrderInfo> getResultList() {
    return this.resultList;
  }

  public ReturnData setResultList(List<WinningOrderInfo> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<WinningOrderInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<WinningOrderInfo>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  WinningOrderInfo _elem26;
                  _elem26 = new WinningOrderInfo();
                  _elem26.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReturnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (WinningOrderInfo _iter27 : struct.resultList)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (WinningOrderInfo _iter28 : struct.resultList)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<WinningOrderInfo>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            WinningOrderInfo _elem31;
            _elem31 = new WinningOrderInfo();
            _elem31.read(iprot);
