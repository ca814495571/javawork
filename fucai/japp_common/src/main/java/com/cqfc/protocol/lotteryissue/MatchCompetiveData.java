...
public class MatchCompetiveData implements org.apache.thrift.TBase<MatchCompetiveData, MatchCompetiveData._Fields>, java.io.Serializable, Cloneable, Comparable<MatchCompetiveData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MatchCompetiveData");
  ...
  private static final org.apache.thrift.protocol.TField MATCH_COMPETIVE_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("matchCompetiveList", org.apache.thrift.protocol.TType.LIST, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new MatchCompetiveDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MatchCompetiveDataTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    MATCH_COMPETIVE_LIST((short)4, "matchCompetiveList");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MatchCompetiveData.class, metaDataMap);
  }

  public MatchCompetiveData() {
  }
   ...
   */
  public MatchCompetiveData(MatchCompetiveData other) {
  ...
  public MatchCompetiveData deepCopy() {
    return new MatchCompetiveData(this);
  }
  ...
  public MatchCompetiveData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public MatchCompetiveData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public MatchCompetiveData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public MatchCompetiveData setMatchCompetiveList(List<MatchCompetive> matchCompetiveList) {
    this.matchCompetiveList = matchCompetiveList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MatchCompetiveData)
      return this.equals((MatchCompetiveData)that);
    return false;
  }

  public boolean equals(MatchCompetiveData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MatchCompetiveData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MatchCompetiveData(");
    boolean first = true;
  ...
  private static class MatchCompetiveDataStandardSchemeFactory implements SchemeFactory {
    public MatchCompetiveDataStandardScheme getScheme() {
      return new MatchCompetiveDataStandardScheme();
    }
  }

  private static class MatchCompetiveDataStandardScheme extends StandardScheme<MatchCompetiveData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MatchCompetiveData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.matchCompetiveList = new ArrayList<MatchCompetive>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  MatchCompetive _elem42;
                  _elem42 = new MatchCompetive();
                  _elem42.read(iprot);
                  struct.matchCompetiveList.add(_elem42);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MatchCompetiveData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.matchCompetiveList != null) {
        oprot.writeFieldBegin(MATCH_COMPETIVE_LIST_FIELD_DESC);
        {
          ...
          for (MatchCompetive _iter43 : struct.matchCompetiveList)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MatchCompetiveDataTupleSchemeFactory implements SchemeFactory {
    public MatchCompetiveDataTupleScheme getScheme() {
      return new MatchCompetiveDataTupleScheme();
    }
  }

  private static class MatchCompetiveDataTupleScheme extends TupleScheme<MatchCompetiveData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MatchCompetiveData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMatchCompetiveList()) {
        {
          ...
          for (MatchCompetive _iter44 : struct.matchCompetiveList)
          {
            _iter44.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MatchCompetiveData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.matchCompetiveList = new ArrayList<MatchCompetive>(_list45.size);
          for (int _i46 = 0; _i46 < _list45.size; ++_i46)
          {
            MatchCompetive _elem47;
            _elem47 = new MatchCompetive();
            _elem47.read(iprot);
            struct.matchCompetiveList.add(_elem47);
          }
        }
        struct.setMatchCompetiveListIsSet(true);
      }
