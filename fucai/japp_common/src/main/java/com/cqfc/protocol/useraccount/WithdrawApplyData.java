...
public class WithdrawApplyData implements org.apache.thrift.TBase<WithdrawApplyData, WithdrawApplyData._Fields>, java.io.Serializable, Cloneable, Comparable<WithdrawApplyData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WithdrawApplyData");
  ...
  static {
    schemes.put(StandardScheme.class, new WithdrawApplyDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WithdrawApplyDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<WithdrawApply> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WithdrawApplyData.class, metaDataMap);
  }
   ...
   */
  public WithdrawApplyData(WithdrawApplyData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<WithdrawApply> __this__resultList = new ArrayList<WithdrawApply>(other.resultList.size());
      for (WithdrawApply other_element : other.resultList) {
        __this__resultList.add(new WithdrawApply(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public WithdrawApplyData deepCopy() {
    return new WithdrawApplyData(this);
  }
  ...
  public WithdrawApplyData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public WithdrawApplyData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public WithdrawApplyData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<WithdrawApply> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(WithdrawApply elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<WithdrawApply>();
    }
    this.resultList.add(elem);
  }

  public List<WithdrawApply> getResultList() {
    return this.resultList;
  }

  public WithdrawApplyData setResultList(List<WithdrawApply> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<WithdrawApply>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WithdrawApplyData)
      return this.equals((WithdrawApplyData)that);
    return false;
  }

  public boolean equals(WithdrawApplyData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(WithdrawApplyData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WithdrawApplyData(");
    boolean first = true;
  ...
  private static class WithdrawApplyDataStandardSchemeFactory implements SchemeFactory {
    public WithdrawApplyDataStandardScheme getScheme() {
      return new WithdrawApplyDataStandardScheme();
    }
  }

  private static class WithdrawApplyDataStandardScheme extends StandardScheme<WithdrawApplyData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WithdrawApplyData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<WithdrawApply>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  WithdrawApply _elem42;
                  _elem42 = new WithdrawApply();
                  _elem42.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WithdrawApplyData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (WithdrawApply _iter43 : struct.resultList)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class WithdrawApplyDataTupleSchemeFactory implements SchemeFactory {
    public WithdrawApplyDataTupleScheme getScheme() {
      return new WithdrawApplyDataTupleScheme();
    }
  }

  private static class WithdrawApplyDataTupleScheme extends TupleScheme<WithdrawApplyData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WithdrawApplyData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (WithdrawApply _iter44 : struct.resultList)
          {
            _iter44.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WithdrawApplyData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<WithdrawApply>(_list45.size);
          for (int _i46 = 0; _i46 < _list45.size; ++_i46)
          {
            WithdrawApply _elem47;
            _elem47 = new WithdrawApply();
            _elem47.read(iprot);
