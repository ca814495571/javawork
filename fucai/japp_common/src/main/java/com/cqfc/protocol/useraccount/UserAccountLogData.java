...
public class UserAccountLogData implements org.apache.thrift.TBase<UserAccountLogData, UserAccountLogData._Fields>, java.io.Serializable, Cloneable, Comparable<UserAccountLogData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserAccountLogData");
  ...
  static {
    schemes.put(StandardScheme.class, new UserAccountLogDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserAccountLogDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<UserAccountLog> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserAccountLogData.class, metaDataMap);
  }

  public UserAccountLogData() {
  }
  ...
  public UserAccountLogData(
    ...
    int pageSize,
    int totalSize,
    List<UserAccountLog> resultList)
  {
    this();
   ...
   */
  public UserAccountLogData(UserAccountLogData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<UserAccountLog> __this__resultList = new ArrayList<UserAccountLog>(other.resultList.size());
      for (UserAccountLog other_element : other.resultList) {
        __this__resultList.add(new UserAccountLog(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public UserAccountLogData deepCopy() {
    return new UserAccountLogData(this);
  }
  ...
  public UserAccountLogData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public UserAccountLogData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public UserAccountLogData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<UserAccountLog> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(UserAccountLog elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<UserAccountLog>();
    }
    this.resultList.add(elem);
  }

  public List<UserAccountLog> getResultList() {
    return this.resultList;
  }

  public UserAccountLogData setResultList(List<UserAccountLog> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<UserAccountLog>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserAccountLogData)
      return this.equals((UserAccountLogData)that);
    return false;
  }

  public boolean equals(UserAccountLogData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UserAccountLogData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserAccountLogData(");
    boolean first = true;
  ...
  private static class UserAccountLogDataStandardSchemeFactory implements SchemeFactory {
    public UserAccountLogDataStandardScheme getScheme() {
      return new UserAccountLogDataStandardScheme();
    }
  }

  private static class UserAccountLogDataStandardScheme extends StandardScheme<UserAccountLogData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserAccountLogData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<UserAccountLog>(_list32.size);
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  UserAccountLog _elem34;
                  _elem34 = new UserAccountLog();
                  _elem34.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserAccountLogData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (UserAccountLog _iter35 : struct.resultList)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class UserAccountLogDataTupleSchemeFactory implements SchemeFactory {
    public UserAccountLogDataTupleScheme getScheme() {
      return new UserAccountLogDataTupleScheme();
    }
  }

  private static class UserAccountLogDataTupleScheme extends TupleScheme<UserAccountLogData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserAccountLogData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (UserAccountLog _iter36 : struct.resultList)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserAccountLogData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<UserAccountLog>(_list37.size);
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            UserAccountLog _elem39;
            _elem39 = new UserAccountLog();
            _elem39.read(iprot);
