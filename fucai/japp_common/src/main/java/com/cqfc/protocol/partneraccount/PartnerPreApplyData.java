...
public class PartnerPreApplyData implements org.apache.thrift.TBase<PartnerPreApplyData, PartnerPreApplyData._Fields>, java.io.Serializable, Cloneable, Comparable<PartnerPreApplyData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PartnerPreApplyData");
  ...
  static {
    schemes.put(StandardScheme.class, new PartnerPreApplyDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PartnerPreApplyDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<PartnerPreApply> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PartnerPreApplyData.class, metaDataMap);
  }

  public PartnerPreApplyData() {
  }
  ...
  public PartnerPreApplyData(
    ...
    int pageSize,
    int totalSize,
    List<PartnerPreApply> resultList)
  {
    this();
   ...
   */
  public PartnerPreApplyData(PartnerPreApplyData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<PartnerPreApply> __this__resultList = new ArrayList<PartnerPreApply>(other.resultList.size());
      for (PartnerPreApply other_element : other.resultList) {
        __this__resultList.add(new PartnerPreApply(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public PartnerPreApplyData deepCopy() {
    return new PartnerPreApplyData(this);
  }
  ...
  public PartnerPreApplyData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public PartnerPreApplyData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public PartnerPreApplyData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<PartnerPreApply> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(PartnerPreApply elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<PartnerPreApply>();
    }
    this.resultList.add(elem);
  }

  public List<PartnerPreApply> getResultList() {
    return this.resultList;
  }

  public PartnerPreApplyData setResultList(List<PartnerPreApply> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<PartnerPreApply>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartnerPreApplyData)
      return this.equals((PartnerPreApplyData)that);
    return false;
  }

  public boolean equals(PartnerPreApplyData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PartnerPreApplyData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartnerPreApplyData(");
    boolean first = true;
  ...
  private static class PartnerPreApplyDataStandardSchemeFactory implements SchemeFactory {
    public PartnerPreApplyDataStandardScheme getScheme() {
      return new PartnerPreApplyDataStandardScheme();
    }
  }

  private static class PartnerPreApplyDataStandardScheme extends StandardScheme<PartnerPreApplyData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PartnerPreApplyData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<PartnerPreApply>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  PartnerPreApply _elem18;
                  _elem18 = new PartnerPreApply();
                  _elem18.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartnerPreApplyData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (PartnerPreApply _iter19 : struct.resultList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PartnerPreApplyDataTupleSchemeFactory implements SchemeFactory {
    public PartnerPreApplyDataTupleScheme getScheme() {
      return new PartnerPreApplyDataTupleScheme();
    }
  }

  private static class PartnerPreApplyDataTupleScheme extends TupleScheme<PartnerPreApplyData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PartnerPreApplyData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (PartnerPreApply _iter20 : struct.resultList)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PartnerPreApplyData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<PartnerPreApply>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            PartnerPreApply _elem23;
            _elem23 = new PartnerPreApply();
            _elem23.read(iprot);
