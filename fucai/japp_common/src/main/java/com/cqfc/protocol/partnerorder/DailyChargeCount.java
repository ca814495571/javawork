...
public class DailyChargeCount implements org.apache.thrift.TBase<DailyChargeCount, DailyChargeCount._Fields>, java.io.Serializable, Cloneable, Comparable<DailyChargeCount> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DailyChargeCount");
  ...
  private static final org.apache.thrift.protocol.TField CHARGE_TOTAL_MONEY_FIELD_DESC = new org.apache.thrift.protocol.TField("chargeTotalMoney", org.apache.thrift.protocol.TType.I64, (short)3);
  private static final org.apache.thrift.protocol.TField COUNT_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("countTime", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new DailyChargeCountStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DailyChargeCountTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CHARGE_TOTAL_MONEY((short)3, "chargeTotalMoney"),
    COUNT_TIME((short)4, "countTime"),
  ...
  private static final int __CHARGETOTALMONEY_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DailyChargeCount.class, metaDataMap);
  }

  public DailyChargeCount() {
  }
   ...
   */
  public DailyChargeCount(DailyChargeCount other) {
  ...
  public DailyChargeCount deepCopy() {
    return new DailyChargeCount(this);
  }
  ...
  public DailyChargeCount setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public DailyChargeCount setPartnerId(String partnerId) {
    this.partnerId = partnerId;
    return this;
  }
  ...
  public DailyChargeCount setChargeTotalMoney(long chargeTotalMoney) {
    this.chargeTotalMoney = chargeTotalMoney;
    setChargeTotalMoneyIsSet(true);
    return this;
  }
  ...
  public DailyChargeCount setCountTime(String countTime) {
    this.countTime = countTime;
    return this;
  }
  ...
  public DailyChargeCount setCreateTime(String createTime) {
    this.createTime = createTime;
    return this;
  }
  ...
  public DailyChargeCount setLastUpdateTime(String lastUpdateTime) {
    this.lastUpdateTime = lastUpdateTime;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DailyChargeCount)
      return this.equals((DailyChargeCount)that);
    return false;
  }

  public boolean equals(DailyChargeCount that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DailyChargeCount other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DailyChargeCount(");
    boolean first = true;
  ...
  private static class DailyChargeCountStandardSchemeFactory implements SchemeFactory {
    public DailyChargeCountStandardScheme getScheme() {
      return new DailyChargeCountStandardScheme();
    }
  }

  private static class DailyChargeCountStandardScheme extends StandardScheme<DailyChargeCount> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DailyChargeCount struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DailyChargeCount struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DailyChargeCountTupleSchemeFactory implements SchemeFactory {
    public DailyChargeCountTupleScheme getScheme() {
      return new DailyChargeCountTupleScheme();
    }
  }

  private static class DailyChargeCountTupleScheme extends TupleScheme<DailyChargeCount> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DailyChargeCount struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DailyChargeCount struct) throws org.apache.thrift.TException {
