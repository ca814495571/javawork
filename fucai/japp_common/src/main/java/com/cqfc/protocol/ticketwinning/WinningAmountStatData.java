...
public class WinningAmountStatData implements org.apache.thrift.TBase<WinningAmountStatData, WinningAmountStatData._Fields>, java.io.Serializable, Cloneable, Comparable<WinningAmountStatData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WinningAmountStatData");
  ...
  static {
    schemes.put(StandardScheme.class, new WinningAmountStatDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WinningAmountStatDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<WinningAmountStat> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WinningAmountStatData.class, metaDataMap);
  }

  public WinningAmountStatData() {
  }
  ...
  public WinningAmountStatData(
    ...
    int pageSize,
    int totalSize,
    List<WinningAmountStat> resultList)
  {
    this();
   ...
   */
  public WinningAmountStatData(WinningAmountStatData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<WinningAmountStat> __this__resultList = new ArrayList<WinningAmountStat>(other.resultList.size());
      for (WinningAmountStat other_element : other.resultList) {
        __this__resultList.add(new WinningAmountStat(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public WinningAmountStatData deepCopy() {
    return new WinningAmountStatData(this);
  }
  ...
  public WinningAmountStatData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public WinningAmountStatData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public WinningAmountStatData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<WinningAmountStat> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(WinningAmountStat elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<WinningAmountStat>();
    }
    this.resultList.add(elem);
  }

  public List<WinningAmountStat> getResultList() {
    return this.resultList;
  }

  public WinningAmountStatData setResultList(List<WinningAmountStat> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<WinningAmountStat>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WinningAmountStatData)
      return this.equals((WinningAmountStatData)that);
    return false;
  }

  public boolean equals(WinningAmountStatData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(WinningAmountStatData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WinningAmountStatData(");
    boolean first = true;
  ...
  private static class WinningAmountStatDataStandardSchemeFactory implements SchemeFactory {
    public WinningAmountStatDataStandardScheme getScheme() {
      return new WinningAmountStatDataStandardScheme();
    }
  }

  private static class WinningAmountStatDataStandardScheme extends StandardScheme<WinningAmountStatData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WinningAmountStatData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<WinningAmountStat>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  WinningAmountStat _elem10;
                  _elem10 = new WinningAmountStat();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WinningAmountStatData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (WinningAmountStat _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class WinningAmountStatDataTupleSchemeFactory implements SchemeFactory {
    public WinningAmountStatDataTupleScheme getScheme() {
      return new WinningAmountStatDataTupleScheme();
    }
  }

  private static class WinningAmountStatDataTupleScheme extends TupleScheme<WinningAmountStatData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WinningAmountStatData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (WinningAmountStat _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WinningAmountStatData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<WinningAmountStat>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            WinningAmountStat _elem15;
            _elem15 = new WinningAmountStat();
            _elem15.read(iprot);
