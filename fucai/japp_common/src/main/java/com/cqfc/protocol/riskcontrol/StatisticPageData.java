...
public class StatisticPageData implements org.apache.thrift.TBase<StatisticPageData, StatisticPageData._Fields>, java.io.Serializable, Cloneable, Comparable<StatisticPageData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StatisticPageData");
  ...
  static {
    schemes.put(StandardScheme.class, new StatisticPageDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StatisticPageDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<StatisticDataByGame> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StatisticPageData.class, metaDataMap);
  }

  public StatisticPageData() {
  }
  ...
  public StatisticPageData(
    ...
    int pageSize,
    int totalSize,
    List<StatisticDataByGame> resultList)
  {
    this();
   ...
   */
  public StatisticPageData(StatisticPageData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<StatisticDataByGame> __this__resultList = new ArrayList<StatisticDataByGame>(other.resultList.size());
      for (StatisticDataByGame other_element : other.resultList) {
        __this__resultList.add(new StatisticDataByGame(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public StatisticPageData deepCopy() {
    return new StatisticPageData(this);
  }
  ...
  public StatisticPageData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public StatisticPageData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public StatisticPageData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<StatisticDataByGame> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(StatisticDataByGame elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<StatisticDataByGame>();
    }
    this.resultList.add(elem);
  }

  public List<StatisticDataByGame> getResultList() {
    return this.resultList;
  }

  public StatisticPageData setResultList(List<StatisticDataByGame> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<StatisticDataByGame>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StatisticPageData)
      return this.equals((StatisticPageData)that);
    return false;
  }

  public boolean equals(StatisticPageData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StatisticPageData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StatisticPageData(");
    boolean first = true;
  ...
  private static class StatisticPageDataStandardSchemeFactory implements SchemeFactory {
    public StatisticPageDataStandardScheme getScheme() {
      return new StatisticPageDataStandardScheme();
    }
  }

  private static class StatisticPageDataStandardScheme extends StandardScheme<StatisticPageData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StatisticPageData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<StatisticDataByGame>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  StatisticDataByGame _elem2;
                  _elem2 = new StatisticDataByGame();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatisticPageData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (StatisticDataByGame _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class StatisticPageDataTupleSchemeFactory implements SchemeFactory {
    public StatisticPageDataTupleScheme getScheme() {
      return new StatisticPageDataTupleScheme();
    }
  }

  private static class StatisticPageDataTupleScheme extends TupleScheme<StatisticPageData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StatisticPageData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (StatisticDataByGame _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StatisticPageData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<StatisticDataByGame>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            StatisticDataByGame _elem7;
            _elem7 = new StatisticDataByGame();
            _elem7.read(iprot);
