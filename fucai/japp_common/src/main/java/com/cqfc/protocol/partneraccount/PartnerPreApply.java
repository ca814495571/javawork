...
public class PartnerPreApply implements org.apache.thrift.TBase<PartnerPreApply, PartnerPreApply._Fields>, java.io.Serializable, Cloneable, Comparable<PartnerPreApply> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PartnerPreApply");
  ...
  static {
    schemes.put(StandardScheme.class, new PartnerPreApplyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PartnerPreApplyTupleSchemeFactory());
  }
  ...
  private static final int __PREMONEY_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PartnerPreApply.class, metaDataMap);
  }

  public PartnerPreApply() {
  }
   ...
   */
  public PartnerPreApply(PartnerPreApply other) {
  ...
  public PartnerPreApply deepCopy() {
    return new PartnerPreApply(this);
  }
  ...
  public PartnerPreApply setPreApplyId(long preApplyId) {
    this.preApplyId = preApplyId;
    setPreApplyIdIsSet(true);
    return this;
  }
  ...
  public PartnerPreApply setPartnerId(String partnerId) {
    this.partnerId = partnerId;
    return this;
  }
  ...
  public PartnerPreApply setPartnerUniqueNo(String partnerUniqueNo) {
    this.partnerUniqueNo = partnerUniqueNo;
    return this;
  }
  ...
  public PartnerPreApply setPreMoney(long preMoney) {
    this.preMoney = preMoney;
    setPreMoneyIsSet(true);
    return this;
  }
  ...
  public PartnerPreApply setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public PartnerPreApply setCreateTime(String createTime) {
    this.createTime = createTime;
    return this;
  }
  ...
  public PartnerPreApply setLastUpdateTime(String lastUpdateTime) {
    this.lastUpdateTime = lastUpdateTime;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartnerPreApply)
      return this.equals((PartnerPreApply)that);
    return false;
  }

  public boolean equals(PartnerPreApply that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PartnerPreApply other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartnerPreApply(");
    boolean first = true;
  ...
  private static class PartnerPreApplyStandardSchemeFactory implements SchemeFactory {
    public PartnerPreApplyStandardScheme getScheme() {
      return new PartnerPreApplyStandardScheme();
    }
  }

  private static class PartnerPreApplyStandardScheme extends StandardScheme<PartnerPreApply> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PartnerPreApply struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartnerPreApply struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PartnerPreApplyTupleSchemeFactory implements SchemeFactory {
    public PartnerPreApplyTupleScheme getScheme() {
      return new PartnerPreApplyTupleScheme();
    }
  }

  private static class PartnerPreApplyTupleScheme extends TupleScheme<PartnerPreApply> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PartnerPreApply struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PartnerPreApply struct) throws org.apache.thrift.TException {
