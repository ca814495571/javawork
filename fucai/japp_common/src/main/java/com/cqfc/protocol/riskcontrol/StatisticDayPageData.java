...
public class StatisticDayPageData implements org.apache.thrift.TBase<StatisticDayPageData, StatisticDayPageData._Fields>, java.io.Serializable, Cloneable, Comparable<StatisticDayPageData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StatisticDayPageData");
  ...
  static {
    schemes.put(StandardScheme.class, new StatisticDayPageDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StatisticDayPageDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<StatisticDataByDay> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StatisticDayPageData.class, metaDataMap);
  }

  public StatisticDayPageData() {
  }
  ...
  public StatisticDayPageData(
    ...
    int pageSize,
    int totalSize,
    List<StatisticDataByDay> resultList)
  {
    this();
   ...
   */
  public StatisticDayPageData(StatisticDayPageData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<StatisticDataByDay> __this__resultList = new ArrayList<StatisticDataByDay>(other.resultList.size());
      for (StatisticDataByDay other_element : other.resultList) {
        __this__resultList.add(new StatisticDataByDay(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public StatisticDayPageData deepCopy() {
    return new StatisticDayPageData(this);
  }
  ...
  public StatisticDayPageData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public StatisticDayPageData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public StatisticDayPageData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<StatisticDataByDay> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(StatisticDataByDay elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<StatisticDataByDay>();
    }
    this.resultList.add(elem);
  }

  public List<StatisticDataByDay> getResultList() {
    return this.resultList;
  }

  public StatisticDayPageData setResultList(List<StatisticDataByDay> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<StatisticDataByDay>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StatisticDayPageData)
      return this.equals((StatisticDayPageData)that);
    return false;
  }

  public boolean equals(StatisticDayPageData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StatisticDayPageData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StatisticDayPageData(");
    boolean first = true;
  ...
  private static class StatisticDayPageDataStandardSchemeFactory implements SchemeFactory {
    public StatisticDayPageDataStandardScheme getScheme() {
      return new StatisticDayPageDataStandardScheme();
    }
  }

  private static class StatisticDayPageDataStandardScheme extends StandardScheme<StatisticDayPageData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StatisticDayPageData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<StatisticDataByDay>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  StatisticDataByDay _elem10;
                  _elem10 = new StatisticDataByDay();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatisticDayPageData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (StatisticDataByDay _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class StatisticDayPageDataTupleSchemeFactory implements SchemeFactory {
    public StatisticDayPageDataTupleScheme getScheme() {
      return new StatisticDayPageDataTupleScheme();
    }
  }

  private static class StatisticDayPageDataTupleScheme extends TupleScheme<StatisticDayPageData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StatisticDayPageData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (StatisticDataByDay _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StatisticDayPageData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<StatisticDataByDay>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            StatisticDataByDay _elem15;
            _elem15 = new StatisticDataByDay();
            _elem15.read(iprot);
