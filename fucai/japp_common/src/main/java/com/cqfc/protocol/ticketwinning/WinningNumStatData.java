...
public class WinningNumStatData implements org.apache.thrift.TBase<WinningNumStatData, WinningNumStatData._Fields>, java.io.Serializable, Cloneable, Comparable<WinningNumStatData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WinningNumStatData");
  ...
  static {
    schemes.put(StandardScheme.class, new WinningNumStatDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WinningNumStatDataTupleSchemeFactory());
  }

  public int currentPage; // required
  public int pageSize; // required
  public int totalSize; // required
  public List<WinningNumStat> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WinningNumStatData.class, metaDataMap);
  }

  public WinningNumStatData() {
  }
  ...
  public WinningNumStatData(
    ...
    int pageSize,
    int totalSize,
    List<WinningNumStat> resultList)
  {
    this();
   ...
   */
  public WinningNumStatData(WinningNumStatData other) {
    __isset_bitfield = other.__isset_bitfield;
    this.currentPage = other.currentPage;
    this.pageSize = other.pageSize;
    this.totalSize = other.totalSize;
    if (other.isSetResultList()) {
      List<WinningNumStat> __this__resultList = new ArrayList<WinningNumStat>(other.resultList.size());
      for (WinningNumStat other_element : other.resultList) {
        __this__resultList.add(new WinningNumStat(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public WinningNumStatData deepCopy() {
    return new WinningNumStatData(this);
  }
  ...
  public WinningNumStatData setCurrentPage(int currentPage) {
    this.currentPage = currentPage;
    setCurrentPageIsSet(true);
    return this;
  }
  ...
  public WinningNumStatData setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public WinningNumStatData setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<WinningNumStat> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(WinningNumStat elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<WinningNumStat>();
    }
    this.resultList.add(elem);
  }

  public List<WinningNumStat> getResultList() {
    return this.resultList;
  }

  public WinningNumStatData setResultList(List<WinningNumStat> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<WinningNumStat>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WinningNumStatData)
      return this.equals((WinningNumStatData)that);
    return false;
  }

  public boolean equals(WinningNumStatData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(WinningNumStatData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WinningNumStatData(");
    boolean first = true;
  ...
  private static class WinningNumStatDataStandardSchemeFactory implements SchemeFactory {
    public WinningNumStatDataStandardScheme getScheme() {
      return new WinningNumStatDataStandardScheme();
    }
  }

  private static class WinningNumStatDataStandardScheme extends StandardScheme<WinningNumStatData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WinningNumStatData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<WinningNumStat>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  WinningNumStat _elem18;
                  _elem18 = new WinningNumStat();
                  _elem18.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WinningNumStatData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (WinningNumStat _iter19 : struct.resultList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class WinningNumStatDataTupleSchemeFactory implements SchemeFactory {
    public WinningNumStatDataTupleScheme getScheme() {
      return new WinningNumStatDataTupleScheme();
    }
  }

  private static class WinningNumStatDataTupleScheme extends TupleScheme<WinningNumStatData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WinningNumStatData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (WinningNumStat _iter20 : struct.resultList)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WinningNumStatData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<WinningNumStat>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            WinningNumStat _elem23;
            _elem23 = new WinningNumStat();
            _elem23.read(iprot);
