...
public class CancelOrder implements org.apache.thrift.TBase<CancelOrder, CancelOrder._Fields>, java.io.Serializable, Cloneable, Comparable<CancelOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CancelOrder");
  ...
  private static final org.apache.thrift.protocol.TField OUT_TICKET_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("outTicketStatus", org.apache.thrift.protocol.TType.I32, (short)6);
  private static final org.apache.thrift.protocol.TField TOTAL_AMOUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("totalAmount", org.apache.thrift.protocol.TType.I64, (short)7);
  private static final org.apache.thrift.protocol.TField ORDER_CONTENT_FIELD_DESC = new org.apache.thrift.protocol.TField("orderContent", org.apache.thrift.protocol.TType.STRING, (short)8);
  private static final org.apache.thrift.protocol.TField PLAY_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("playType", org.apache.thrift.protocol.TType.STRING, (short)9);
  ...
  static {
    schemes.put(StandardScheme.class, new CancelOrderStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CancelOrderTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    OUT_TICKET_STATUS((short)6, "outTicketStatus"),
    TOTAL_AMOUNT((short)7, "totalAmount"),
    ORDER_CONTENT((short)8, "orderContent"),
    PLAY_TYPE((short)9, "playType"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // ISSUE_NO
          return ISSUE_NO;
        case 6: // OUT_TICKET_STATUS
          return OUT_TICKET_STATUS;
        case 7: // TOTAL_AMOUNT
          return TOTAL_AMOUNT;
        case 8: // ORDER_CONTENT
  ...
  private static final int __OUTTICKETSTATUS_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CancelOrder.class, metaDataMap);
  }
   ...
   */
  public CancelOrder(CancelOrder other) {
  ...
  public CancelOrder setOrderNo(String orderNo) {
    this.orderNo = orderNo;
    return this;
  }
  ...
  public CancelOrder setPartnerId(String partnerId) {
    this.partnerId = partnerId;
    return this;
  }
  ...
  public CancelOrder setUserId(long userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public CancelOrder setLotteryId(String lotteryId) {
    this.lotteryId = lotteryId;
    return this;
  }
  ...
  public CancelOrder setIssueNo(String issueNo) {
    this.issueNo = issueNo;
    return this;
  }
  ...
  public CancelOrder setOutTicketStatus(int outTicketStatus) {
    this.outTicketStatus = outTicketStatus;
    setOutTicketStatusIsSet(true);
    return this;
  }
  ...
  public CancelOrder setTotalAmount(long totalAmount) {
    this.totalAmount = totalAmount;
    setTotalAmountIsSet(true);
    return this;
  }
  ...
  public CancelOrder setOrderContent(String orderContent) {
    this.orderContent = orderContent;
    return this;
  }
  ...
  public CancelOrder setPlayType(String playType) {
    this.playType = playType;
    return this;
  }
  ...
  public CancelOrder setMultiple(int multiple) {
    this.multiple = multiple;
    setMultipleIsSet(true);
    return this;
  }
  ...
  public CancelOrder setCreateTime(String createTime) {
    this.createTime = createTime;
    return this;
  }
  ...
  public CancelOrder setLastUpdateTime(String lastUpdateTime) {
    this.lastUpdateTime = lastUpdateTime;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CancelOrder)
      return this.equals((CancelOrder)that);
    return false;
  }

  public boolean equals(CancelOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CancelOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CancelOrder(");
    boolean first = true;
  ...
  private static class CancelOrderStandardSchemeFactory implements SchemeFactory {
    public CancelOrderStandardScheme getScheme() {
      return new CancelOrderStandardScheme();
    }
  }

  private static class CancelOrderStandardScheme extends StandardScheme<CancelOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CancelOrder struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CancelOrder struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CancelOrderTupleSchemeFactory implements SchemeFactory {
    public CancelOrderTupleScheme getScheme() {
      return new CancelOrderTupleScheme();
    }
  }

  private static class CancelOrderTupleScheme extends TupleScheme<CancelOrder> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CancelOrder struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CancelOrder struct) throws org.apache.thrift.TException {
