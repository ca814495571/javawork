	...
	public static String findLotteryDrawResult(String lotteryId, String issueNo) {
		...
		try {
			...
			method.setParameter("key", Digit.sig((transcode+xmlMsg).getBytes("utf-8"),
					ChongQingTicketIssueConst.KEY_STORE_PASS, ChongQingTicketIssueConst.ALIALS, ClassPathUtil.getClassPathInputStream("")));
			 ...
			 * </msg>	error
			 */
			Log.run.debug("LotteryDrawResult(lotteryId:issueNo@result):" + lotteryId + ":" + issueNo + "@" + result);
