...
import com.cqfc.xmlparser.transactionmsg142.Msg;


public class TransactionMsgLoader142 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg142");
