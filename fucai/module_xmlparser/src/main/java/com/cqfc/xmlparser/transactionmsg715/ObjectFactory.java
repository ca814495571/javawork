 ...
 * generated in the com.cqfc.xmlparser.transactionmsg715 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Queryuserorder_QNAME = new QName("", "queryuserorder");
    private final static QName _Head_QNAME = new QName("", "head");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cqfc.xmlparser.transactionmsg715
     * 
     */
    ...
    /**
     * Create an instance of {@link Unionorder }
     * 
     */
    public Unionorder createUnionorder() {
        return new Unionorder();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "queryuserorder")
    public JAXBElement<Querytype> createQueryuserorder(Querytype value) {
        return new JAXBElement<Querytype>(_Queryuserorder_QNAME, Querytype.class, null, value);
    }
