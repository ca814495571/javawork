...
import com.cqfc.xmlparser.transactionmsg134.Msg;


public class TransactionMsgLoader134 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg134");
