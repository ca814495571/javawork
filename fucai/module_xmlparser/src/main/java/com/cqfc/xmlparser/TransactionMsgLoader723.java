...
import com.cqfc.xmlparser.transactionmsg723.Msg;


public class TransactionMsgLoader723 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg723");
