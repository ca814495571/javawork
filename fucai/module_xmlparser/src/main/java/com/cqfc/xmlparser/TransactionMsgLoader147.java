...
import com.cqfc.xmlparser.transactionmsg147.Msg;


public class TransactionMsgLoader147 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg147");
