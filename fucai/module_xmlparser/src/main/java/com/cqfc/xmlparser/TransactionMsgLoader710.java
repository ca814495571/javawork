...
import com.cqfc.xmlparser.transactionmsg710.Msg;


public class TransactionMsgLoader710 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg710");
