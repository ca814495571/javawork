...
import com.cqfc.xmlparser.transactionmsg743.Msg;


public class TransactionMsgLoader743 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg743");
