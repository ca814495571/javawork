...
import com.cqfc.xmlparser.transactionmsg125.Msg;


public class TransactionMsgLoader125 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg125");
