...
import com.cqfc.xmlparser.transactionmsg203.Msg;


public class TransactionMsgLoader203 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg203");
