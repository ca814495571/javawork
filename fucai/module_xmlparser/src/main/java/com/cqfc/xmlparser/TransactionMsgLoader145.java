...
import com.cqfc.xmlparser.transactionmsg145.Msg;


public class TransactionMsgLoader145 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg145");
