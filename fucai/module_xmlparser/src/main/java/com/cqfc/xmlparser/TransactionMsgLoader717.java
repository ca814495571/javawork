...
import com.cqfc.xmlparser.transactionmsg717.Msg;


public class TransactionMsgLoader717 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg717");
