...
import com.cqfc.xmlparser.transactionmsg755.Msg;


public class TransactionMsgLoader755 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg755");
