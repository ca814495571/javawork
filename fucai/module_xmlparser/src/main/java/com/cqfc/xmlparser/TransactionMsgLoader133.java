...
import com.cqfc.xmlparser.transactionmsg133.Msg;


public class TransactionMsgLoader133 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg133");
