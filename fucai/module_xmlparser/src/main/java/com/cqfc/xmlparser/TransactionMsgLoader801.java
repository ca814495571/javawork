...
import com.cqfc.xmlparser.transactionmsg801.Msg;


public class TransactionMsgLoader801 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg801");
