...
import com.cqfc.xmlparser.transactionmsg747.Msg;


public class TransactionMsgLoader747 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg747");
