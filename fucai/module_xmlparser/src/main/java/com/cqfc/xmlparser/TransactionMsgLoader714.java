...
import com.cqfc.xmlparser.transactionmsg714.Msg;


public class TransactionMsgLoader714 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg714");
