 ...
 * generated in the com.cqfc.xmlparser.transactionmsg118 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Binduser_QNAME = new QName("", "binduser");
    private final static QName _Head_QNAME = new QName("", "head");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cqfc.xmlparser.transactionmsg118
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "binduser")
    public JAXBElement<Querytype> createBinduser(Querytype value) {
        return new JAXBElement<Querytype>(_Binduser_QNAME, Querytype.class, null, value);
    }
