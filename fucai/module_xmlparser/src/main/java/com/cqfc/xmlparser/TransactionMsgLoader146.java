...
import com.cqfc.xmlparser.transactionmsg146.Msg;


public class TransactionMsgLoader146 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg146");
