...
import com.cqfc.xmlparser.transactionmsg613.Msg;


public class TransactionMsgLoader613 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg613");
