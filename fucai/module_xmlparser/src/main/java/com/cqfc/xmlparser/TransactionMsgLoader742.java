...
import com.cqfc.xmlparser.transactionmsg742.Msg;


public class TransactionMsgLoader742 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg742");
