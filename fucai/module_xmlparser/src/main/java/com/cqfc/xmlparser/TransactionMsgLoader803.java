...
import com.cqfc.xmlparser.transactionmsg803.Msg;


public class TransactionMsgLoader803 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg803");
