...
import com.cqfc.xmlparser.transactionmsg148.Msg;


public class TransactionMsgLoader148 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg148");
