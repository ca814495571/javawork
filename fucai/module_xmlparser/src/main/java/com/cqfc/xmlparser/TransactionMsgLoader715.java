...
import com.cqfc.xmlparser.transactionmsg715.Msg;


public class TransactionMsgLoader715 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg715");
