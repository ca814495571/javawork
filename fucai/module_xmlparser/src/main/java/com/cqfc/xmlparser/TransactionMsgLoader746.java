...
import com.cqfc.xmlparser.transactionmsg746.Msg;


public class TransactionMsgLoader746 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg746");
