...
import com.cqfc.xmlparser.transactionmsg718.Msg;


public class TransactionMsgLoader718 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg718");
