...
import com.cqfc.xmlparser.transactionmsg619.Msg;


public class TransactionMsgLoader619 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg619");
