...
import com.cqfc.xmlparser.transactionmsg757.Msg;


public class TransactionMsgLoader757 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg757");
