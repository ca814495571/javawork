...
import com.cqfc.xmlparser.transactionmsg143.Msg;


public class TransactionMsgLoader143 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg143");
