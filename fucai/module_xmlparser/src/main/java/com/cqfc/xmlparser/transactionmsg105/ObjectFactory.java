 ...
 * generated in the com.cqfc.xmlparser.transactionmsg105 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Queryticket_QNAME = new QName("", "queryticket");
    private final static QName _Head_QNAME = new QName("", "head");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cqfc.xmlparser.transactionmsg105
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "queryticket")
    public JAXBElement<Querytype> createQueryticket(Querytype value) {
        return new JAXBElement<Querytype>(_Queryticket_QNAME, Querytype.class, null, value);
    }
