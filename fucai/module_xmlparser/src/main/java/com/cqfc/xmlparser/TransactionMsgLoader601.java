...
import com.cqfc.xmlparser.transactionmsg601.Msg;


public class TransactionMsgLoader601 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg601");
