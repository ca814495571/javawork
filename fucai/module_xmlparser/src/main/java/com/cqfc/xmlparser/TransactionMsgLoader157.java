...
import com.cqfc.xmlparser.transactionmsg157.Msg;


public class TransactionMsgLoader157 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg157");
