...
import com.cqfc.xmlparser.transactionmsg762.Msg;


public class TransactionMsgLoader762 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg762");
