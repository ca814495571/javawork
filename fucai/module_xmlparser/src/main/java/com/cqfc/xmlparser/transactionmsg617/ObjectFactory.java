 ...
 * generated in the com.cqfc.xmlparser.transactionmsg617 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Withdrawresult_QNAME = new QName("", "withdrawresult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cqfc.xmlparser.transactionmsg617
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "withdrawresult")
    public JAXBElement<Querytype> createWithdrawresult(Querytype value) {
        return new JAXBElement<Querytype>(_Withdrawresult_QNAME, Querytype.class, null, value);
    }
