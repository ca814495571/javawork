...
import com.cqfc.xmlparser.transactionmsg126.Msg;


public class TransactionMsgLoader126 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg126");
