...
import com.cqfc.xmlparser.transactionmsg707.Msg;


public class TransactionMsgLoader707 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg707");
