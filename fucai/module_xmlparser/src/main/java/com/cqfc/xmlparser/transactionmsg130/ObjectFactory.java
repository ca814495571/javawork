 ...
 * generated in the com.cqfc.xmlparser.transactionmsg130 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Queryorder_QNAME = new QName("", "queryorder");
    private final static QName _Head_QNAME = new QName("", "head");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cqfc.xmlparser.transactionmsg130
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "queryorder")
    public JAXBElement<Querytype> createQueryorder(Querytype value) {
        return new JAXBElement<Querytype>(_Queryorder_QNAME, Querytype.class, null, value);
    }
