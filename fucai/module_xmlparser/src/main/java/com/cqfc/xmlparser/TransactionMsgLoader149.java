...
import com.cqfc.xmlparser.transactionmsg149.Msg;


public class TransactionMsgLoader149 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg149");
