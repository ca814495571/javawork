...
import com.cqfc.xmlparser.transactionmsg725.Msg;


public class TransactionMsgLoader725 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg725");
