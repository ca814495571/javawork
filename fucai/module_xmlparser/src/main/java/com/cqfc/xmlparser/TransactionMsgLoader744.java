...
import com.cqfc.xmlparser.transactionmsg744.Msg;


public class TransactionMsgLoader744 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg744");
