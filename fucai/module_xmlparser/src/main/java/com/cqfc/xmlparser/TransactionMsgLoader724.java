...
import com.cqfc.xmlparser.transactionmsg724.Msg;


public class TransactionMsgLoader724 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg724");
