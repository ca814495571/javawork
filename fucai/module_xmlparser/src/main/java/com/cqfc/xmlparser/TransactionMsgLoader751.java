...
import com.cqfc.xmlparser.transactionmsg751.Msg;


public class TransactionMsgLoader751 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg751");
