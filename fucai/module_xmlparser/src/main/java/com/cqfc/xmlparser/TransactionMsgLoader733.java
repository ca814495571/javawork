...
import com.cqfc.xmlparser.transactionmsg733.Msg;


public class TransactionMsgLoader733 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg733");
