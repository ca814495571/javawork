...
import com.cqfc.xmlparser.transactionmsg763.Msg;


public class TransactionMsgLoader763 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg763");
