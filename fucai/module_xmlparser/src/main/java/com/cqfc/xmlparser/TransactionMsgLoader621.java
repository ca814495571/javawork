...
import com.cqfc.xmlparser.transactionmsg621.Msg;


public class TransactionMsgLoader621 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg621");
