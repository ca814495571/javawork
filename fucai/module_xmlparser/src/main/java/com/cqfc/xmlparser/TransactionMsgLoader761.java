...
import com.cqfc.xmlparser.transactionmsg761.Msg;


public class TransactionMsgLoader761 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg761");
