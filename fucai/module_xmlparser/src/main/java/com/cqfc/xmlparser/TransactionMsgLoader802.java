...
import com.cqfc.xmlparser.transactionmsg802.Msg;


public class TransactionMsgLoader802 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg802");
