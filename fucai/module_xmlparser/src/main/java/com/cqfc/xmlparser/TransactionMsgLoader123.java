...
import com.cqfc.xmlparser.transactionmsg123.Msg;


public class TransactionMsgLoader123 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg123");
