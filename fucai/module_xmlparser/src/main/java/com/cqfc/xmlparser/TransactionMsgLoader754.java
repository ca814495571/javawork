...
import com.cqfc.xmlparser.transactionmsg754.Msg;


public class TransactionMsgLoader754 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg754");
