...
import com.cqfc.xmlparser.transactionmsg716.Msg;


public class TransactionMsgLoader716 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg716");
