...
import com.cqfc.xmlparser.transactionmsg114.Msg;


public class TransactionMsgLoader114 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg114");
