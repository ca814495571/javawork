...
import com.cqfc.xmlparser.transactionmsg745.Msg;


public class TransactionMsgLoader745 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg745");
