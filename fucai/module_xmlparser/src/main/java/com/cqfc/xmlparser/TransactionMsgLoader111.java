...
import com.cqfc.xmlparser.transactionmsg111.Msg;


public class TransactionMsgLoader111 {
	private static final JAXBContext jaxbContext = initContext();

    private static JAXBContext initContext() {
        try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg111");
