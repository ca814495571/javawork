...
import com.cqfc.xmlparser.transactionmsg119.Msg;


public class TransactionMsgLoader119 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg119");
