...
import com.cqfc.xmlparser.transactionmsg109.Msg;


public class TransactionMsgLoader109 {
	private static final JAXBContext jaxbContext = initContext();

    private static JAXBContext initContext() {
        try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg109");
