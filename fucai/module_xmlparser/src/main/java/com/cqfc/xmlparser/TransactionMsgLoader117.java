...
import com.cqfc.xmlparser.transactionmsg117.Msg;

public class TransactionMsgLoader117 {

	private static final JAXBContext jaxbContext = initContext();

	private static JAXBContext initContext() {
 		try {
			return JAXBContext.newInstance("com.cqfc.xmlparser.transactionmsg117");
