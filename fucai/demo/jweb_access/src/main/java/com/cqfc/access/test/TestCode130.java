...
public class TestCode130 {
	...
	public void getIssue() {
		...
		String transcode = "130";

		String xml111 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='130' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "         <queryorder userid='3' ordertype='2' gameid='SSQ' from='1' size ='10'/>\n "
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("130返回的消息体内容730:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode130 test107 = new TestCode130();
