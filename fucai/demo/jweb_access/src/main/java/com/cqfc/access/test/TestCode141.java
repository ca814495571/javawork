...
public class TestCode141 {
	 ...
	 * 接入渠道的id
	 */
	public final static String partner_id = "00860002";
	...
	public void getIssue() {
		...
		String transcode = "141";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='141' partnerid='00860002' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <partnerDateQuery date='20140822' />\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode141 test103 = new TestCode141();
