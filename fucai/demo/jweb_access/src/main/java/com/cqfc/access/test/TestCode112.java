...
public class TestCode112 {
	 ...
	 * 当前期号
	 */
	public static String issue_no = "2014001";
	...
	public void getIssue() {
		...
		String xml112 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='112' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <giftinfo giftid = '74126'/>\n"
				+ "      </body>\n" + "</msg>";

		this.send(xml112, transcode);
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("112返回的消息体内容711:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode112 test107 = new TestCode112();
