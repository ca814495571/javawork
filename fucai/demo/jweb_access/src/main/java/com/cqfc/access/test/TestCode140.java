...
public class TestCode140 {
	...
	public void getIssue() {
		...
		String transcode = "140";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='140' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <partnerIssueQuery gameid='SSQ' issueno='123' />\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode140 test103 = new TestCode140();
