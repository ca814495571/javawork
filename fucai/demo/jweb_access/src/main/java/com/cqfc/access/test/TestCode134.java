...
public class TestCode134 {
	...
	public void getIssue() {
		...
		String transcode = "134";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='134' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <prizequery userid='28' pid='3' seriesno='' />\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode134 test103 = new TestCode134();
