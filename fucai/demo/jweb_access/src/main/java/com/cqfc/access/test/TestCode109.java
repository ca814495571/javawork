...
public class TestCode109 {
	...
	public void getIssue() {
		...
		String transcode = "109";

		String xml107 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='109' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <partneraccount partnerid='00860001'/>\n"
				+ "      </body>\n" + "</msg>";

		this.send(xml107, transcode);
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("109返回的消息体内容709:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode109 test107 = new TestCode109();
