...
public class ReturnData implements org.apache.thrift.TBase<ReturnData, ReturnData._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<ChannelCooperation> resultList; // required
  ...
  public ReturnData(
    ...
    int pageSize,
    int totalSize,
    List<ChannelCooperation> resultList)
  {
    this();
  ...
  public ReturnData(ReturnData other) {
    ...
    if (other.isSetResultList()) {
      List<ChannelCooperation> __this__resultList = new ArrayList<ChannelCooperation>();
      for (ChannelCooperation other_element : other.resultList) {
        __this__resultList.add(new ChannelCooperation(other_element));
      }
  ...
  public java.util.Iterator<ChannelCooperation> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(ChannelCooperation elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<ChannelCooperation>();
    }
    this.resultList.add(elem);
  }

  public List<ChannelCooperation> getResultList() {
    return this.resultList;
  }

  public ReturnData setResultList(List<ChannelCooperation> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<ChannelCooperation>)value);
      }
      break;
  ...
  public int compareTo(ReturnData other) {
    ...
    ReturnData typedOther = (ReturnData)other;
    ...
    lastComparison = Boolean.valueOf(isSetResultList()).compareTo(typedOther.isSetResultList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetResultList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.resultList, typedOther.resultList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<ChannelCooperation>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  ChannelCooperation _elem2; // required
                  _elem2 = new ChannelCooperation();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReturnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (ChannelCooperation _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (ChannelCooperation _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resultList = new ArrayList<ChannelCooperation>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            ChannelCooperation _elem7; // required
            _elem7 = new ChannelCooperation();
            _elem7.read(iprot);
