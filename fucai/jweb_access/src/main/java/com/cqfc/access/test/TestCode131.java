...
public class TestCode131 {
	...
	public void getIssue() {
		...
		String transcode = "131";

		String xml131 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='131' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "         <queryencash userid = '3' fromtime='2014-6-6 00:00:00' totime='2014-7-6 00:00:00' from='1' size='10'/>\n "
				+ "      </body>\n" + "</msg>";

		this.send(xml131, transcode);
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("131返回的消息体内容731:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode131 test107 = new TestCode131();
