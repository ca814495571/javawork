...
public class TestCode149 {
	...
	public void getIssue() {
		...
		String transcode = "149";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='149' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <partnerDateQuery date='20140822' partnerid='00860001'  />\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode149 test103 = new TestCode149();
