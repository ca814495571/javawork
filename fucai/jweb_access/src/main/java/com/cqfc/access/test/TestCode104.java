...
//	public final static String private_scret_url = ClassPathUtil.getClassPath() + "19_private";
	 ...
	 * 接入渠道的id
	 */
	public final static String partner_id = "00860000001";
	...
	public void getIssue() {
		...
		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
						+ "<msg>\n"
						+ "      <head transcode='104' partnerid='00860000001' version='1.0' time='200911120000'/>\n"
						+ "      <body>\n"
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("104返回的消息体内容704:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode104 test104 = new TestCode104();
