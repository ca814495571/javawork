...
public class TestCode132 {
	...
	public void getIssue() {
		...
		String xml132 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='132' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "         <queryuseraccount userid = '28' fromtime='2014-6-6 00:00:00' totime='2014-9-6 00:00:00' from='1' size='10'/>\n "
				+ "      </body>\n" + "</msg>";

		this.send(xml132, transcode);
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("132返回的消息体内容732:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode132 test107 = new TestCode132();
