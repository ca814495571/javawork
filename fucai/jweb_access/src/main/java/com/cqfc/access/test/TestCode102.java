...
public class TestCode102 {
	...
	public void getIssue() {
		...
		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='102' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <queryprizenotice gameid='SSQ' issue='2014001' privance='tj'/>\n"
				+ "      </body>\n" + "</msg>";
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("102返回的消息体内容702:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode102 test101 = new TestCode102();
