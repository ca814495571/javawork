...
public class TestCode107 {
	...
	public void getIssue() {
		...
		String xml107 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='107' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <chargeuporder chargeid='20141226001' money='10'/>\n"
				+ "      </body>\n" + "</msg>";
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("107返回的消息体内容701:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode107 test107 = new TestCode107();
