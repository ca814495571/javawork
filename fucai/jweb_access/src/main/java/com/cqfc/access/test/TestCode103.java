...
public class TestCode103 {
	...
	public void getIssue() {
		...
		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='103' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <queryprizenotice gameid='SSQ' issue='123' />\n"
				+ "      </body>\n" + "</msg>";
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("103返回的消息体内容703:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode103 test103 = new TestCode103();
