...
public class TestCode157 {
	 ...
	 * 接入渠道的id
	 */
	public final static String partner_id = "00860001createUserPreApply";
	...
	public void getIssue() {
		...
		String transcode = "157";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='157' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <preview userId='3' pid='120' money='100.12'></preview>\n"
				+ "      </body>\n" + "</msg>";
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("140返回的消息体内容740:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode157 test103 = new TestCode157();
