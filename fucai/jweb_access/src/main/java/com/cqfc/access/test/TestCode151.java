...
public class TestCode151 {
	...
	public void getIssue() {
		...
		String transcode = "151";

		String msg = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='151' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "          <queryissue gameid='SSQ' issueno='2014001' province='tj'/>\n"
				+ "      </body>\n" + "</msg>";
	...
	public boolean send(String msg, String transcode) {
		...
		try {
			...
			System.out.println(new StringBuilder().append("151返回的消息体内容701:")
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode151 test151 = new TestCode151();
