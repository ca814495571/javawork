...
public class TestCode117 {
	...
	public void getIssue() {
		...
		String transcode = "117";

		String xml111 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='117' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "         <querywithdraw   id='2009123'  userid='3'  fromtime='2014-7-7' from='1' size='10'/>\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode117 test107 = new TestCode117();
