...
public class TestCode116 {
	...
	public void getIssue() {
		...
		String transcode = "116";

		String xml111 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				+ "<msg>\n"
				+ "      <head transcode='116' partnerid='00860001' version='1.0' time='200911120000'/>\n"
				+ "      <body>\n"
				+ "         <withdraw   bankname='test' cardno='1232121' branch='TEST' money='100' id='2009123' cardusername='test' userid='28' />\n"
				+ "      </body>\n" + "</msg>";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TestCode116 test107 = new TestCode116();
